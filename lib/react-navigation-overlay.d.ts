...
export declare const ReactNavigationOverlay: ({ style, animationIn, animationOut, onModalHide, ...props }: IReactNavigationOverlayProps) => React.JSX.Element | null;
export {};
